...
import SqlBlobHandler from "./handlers/SqlBlobHandler";
import SqlBlockBlobHandler from "./handlers/SqlBlockBlobHandler";
...
export default class SqlBlobRequestListenerFactory
  ...
  public createRequestListener(): RequestListener {
    ...
    const handlers: IHandlers = {
      ...
      blobHandler: new SqlBlobHandler(
        this.dataStore,
        this.metadataStore,
        this.extentStore,
        logger,
      ...
      blockBlobHandler: new SqlBlockBlobHandler(
        this.dataStore,
        this.metadataStore,
        this.extentStore,
        logger
